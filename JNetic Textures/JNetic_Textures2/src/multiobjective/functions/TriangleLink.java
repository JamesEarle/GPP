...
/**
 * This class represents a triangle loop function in the function set which
 * draws a triangle with a textured background, as well as an additional shape.
 *
 * @author Steve Bergen
 */

public class TriangleLink extends GPNode {
    ...
    public void eval (final EvolutionState state,
        ...
        children[9].eval(state,thread,input,stack,individual,problem);
