...
/**
 * This class represents a rendering function which has one child; an RGB
 * value. The RGB value is for background color.
 *
 * @author Steve Bergen
 */

public class RenderTexture extends GPNode {
