...
/**
 * This class represents a rectangle loop function in the function set which
 * draws a rectangle with a textured background, as well as an additional shape.
 *
 * @author Steve Bergen
 */

public class RectangleLink extends GPNode {
