package multiobjective.overrides;
...
public class TournamentSelection extends SelectionMethod implements SteadyStateBSourceForm
    ...
    public void setup(final EvolutionState state, final Parameter base)
        ...
        param.GPParameters.TSELECT_OBJECT = this;
    ...
    public int produce(final int min,
        ...
        for(int q = 0; q < n; q++)
            ...
            while ( true ) {
                ...
                i = state.random[thread].nextInt(oldinds.length);
                bad = i;
                ...
                for (int x=1;x<size;x++)
                    ...
                    int j = i;
                    while ( i == j )
                        j = state.random[thread].nextInt(oldinds.length);
                ...
                // MAYBE REMOVE THIS IF FINDING INFINITE LOOPS
                if ( old != -1 && old != i && 
                        ((KozaFitness)oldinds[old].fitness).standardizedFitness()
                        == ((KozaFitness)oldinds[i].fitness).standardizedFitness()
                        && state.random[thread].nextDouble() < 0.2 ) break;
