...
/**
 * This class represents an texture-rgb mixer function in the function set. It
 * has two children, a texture and a color, and it mixes the two based upon
 * their alpha values.
 *
 * @author Steve Bergen
 */

public class TextureColorMix extends GPNode {
    ...
    public void eval (final EvolutionState state,
        ...
        c = new RGBAColor(rd.color.getRed(), rd.color.getGreen(), rd.color.getBlue(), rd.color.getAlpha());

        rd.texture = new MergedTexture(new SolidTexture(c), t1);
